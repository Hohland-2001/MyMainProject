...
def test_get_mask_card_number(number_1: str, number_2: str, number_3: str, number_4: str) -> None:
...
def test_get_mask_account(number_1: str, number_2: str, number_3: str, number_4: str) -> None:
